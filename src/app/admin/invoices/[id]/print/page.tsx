    ...
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mb-6 flex items-center justify-between print:hidden">
        <a
          ...
          className="text-body-dense font-medium text-muted-foreground hover:text-foreground"
        >
      ...
      <article className="rounded-2xl bg-white p-8 shadow-rest print:rounded-none print:border-0 print:p-0 print:shadow-none">
        ...
        {/* Parties + meta */}
        <section className="grid grid-cols-2 gap-6 py-6 text-body-dense">
          <div>
        ...
        <section className="mt-4 flex justify-end">
          <div className="w-64 space-y-1 text-body-dense">
        ...
        {invoice.notes && (
          <section className="mt-6 border-t border-border pt-4 text-body-dense">
