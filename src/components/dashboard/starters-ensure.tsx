...
export function StartersEnsure({ seeded }: { seeded: boolean }) {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 z-50 flex -translate-x-1/2 items-center gap-2 rounded-full border border-border bg-white px-4 py-2 text-[13px] font-medium text-foreground shadow-[0_8px_40px_rgba(15,23,42,0.15)]">
